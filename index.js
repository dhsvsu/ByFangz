...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["Bug Simple Fangz", "Dekstop", "3.0"]})
console.log(color('[ Base Ori Fangz ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Fangz-MD\n➸ Creator : Fangz\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Fangz Official`\n➸ My Instagram : @fangzxd\n\nThanks\n', 'red'))
